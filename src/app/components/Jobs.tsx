      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {filtered.map((j, i) => (
              <div key={j.id} className="card-glow rounded-xl p-5 animate-fade-in-up" style={{ background: "linear-gradient(145deg, #0f1a0f, #0b150b)", animationDelay: `${i * 0.07}s`, opacity: 0, animationFillMode: "forwards" }}>
