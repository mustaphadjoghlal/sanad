              ...
              >
                ...
                <div className="relative overflow-hidden" style={{ height: "180px" }}>
                  ...
                  <span
                    ...
                    style={{ background: typeBg[c.type] || "rgba(0,98,51,0.6)", color: typeColor[c.type] || "#81c784", backdropFilter: "blur(4px)" }}
                  >
                    {typeLabel[c.type]}
                  </span>
                </div>
                ...
                <div className="p-4">
                  ...
                  {c.description && (
                    <p
                      ...
                      style={{ color: "#4a7a4a", lineHeight: 1.6, display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden" }}
                    >
                      {c.description}
                    </p>
                  )}
                  ...
                  <div className="flex items-center justify-between mt-3 pt-3" style={{ borderTop: "1px solid rgba(0,98,51,0.12)" }}>
                    <div className="flex items-center gap-1 text-xs" style={{ color: "#4a7a4a" }}>
                      <Calendar size={12} />
